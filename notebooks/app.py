# app.py — short intro, no GH explainer, tidy UI + recs + what-ifs
...
d1, d2 = st.columns(2)
with d1:
    phys_days = st.slider("No bad physical health days (0–30)", 0, 30, 2)
with d2:
    ment_days = st.slider("No bad mental health days (0–30)", 0, 30, 2)
...
# General Health → numeric and/or one-hot
if GEN_ONEHOTS:
